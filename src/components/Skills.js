...
const Skill = ({name, x, y}) => {
    return (
        <motion.div
            className='flex items-ceneter justify-center rounded-full font-semibold bg-dark text-light py-3 px-6 shadow-dark cursor-pointer absolute capitalize'
  ...
  return (
    <>
        ...
        <div className='w-full h-screen relative flex items-center justify-center rounded-full bg-circularLight'>
            ...
            <motion.div
            className='flex items-ceneter justify-center rounded-full font-semibold bg-dark text-light p-8 shadow-dark cursor-pointer'
            whileHover={{ scale: 1.05 }}>
                web
            </motion.div>
