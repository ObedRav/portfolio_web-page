...
const Skill = ({name, x, y}) => {
    return (
        <motion.div
            className='flex items-ceneter justify-center rounded-full font-semibold bg-dark text-light py-3 px-6 shadow-dark cursor-pointer absolute capitalize dark:text-dark dark:bg-light'
...
const Skills = () => {
  return (
    <>
        <h2 className='font-bold text-8xl mt-64 w-full text-center mb-8'>Skills</h2>
        <div className='w-full h-screen relative flex items-center justify-center rounded-full bg-circularLight dark:bg-circularDark'>

            <motion.div
            className='flex items-ceneter justify-center rounded-full font-semibold bg-dark text-light p-8 shadow-dark cursor-pointer dark:text-dark dark:bg-light'
            whileHover={{ scale: 1.05 }}>
                web
            </motion.div>
